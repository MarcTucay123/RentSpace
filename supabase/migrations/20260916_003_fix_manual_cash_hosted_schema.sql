-- The hosted single-dormitory schema does not include the legacy properties
-- table. Keep the RPC aligned with the approved-landlord RLS model used by
-- tenant assignments, rental obligations, and payments.
